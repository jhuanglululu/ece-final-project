...
const float MUSIC_NOTE[] = {
    261.63, 329.63, 349.23, 392.00, 349.23, 329.63, 261.63, 329.63, 349.23, 392.00, 349.23,
    329.63, 261.63, 329.63, 349.23, 392.00, 349.23, 329.63, 261.63, 196.00, 246.94, 261.63
};

const int MUSIC_DURATION[] =
    { 500, 500, 500, 500, 250, 250, 500, 500, 500, 500, 250, 250, 500, 500, 500, 500, 250, 250, 500, 500, 500, 500 };

const int MUSIC_PAUSE[] =
    { 100, 100, 50, 50, 50, 100, 100, 100, 50, 50, 50, 100, 100, 100, 50, 50, 50, 100, 100, 50, 50, 100 };
